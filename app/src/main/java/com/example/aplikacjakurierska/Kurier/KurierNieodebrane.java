...
public class KurierNieodebrane extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kurier_nieodebrane);

        cofnij=findViewById(R.id.bKurierNieodebraneCofnij);
        lvLista=findViewById(R.id.lvKurierNieodebraneLista);
        ...
        fStore.collection("users").document(id).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                fStore.collection("paczki").whereEqualTo("Dostarczona", "Nieodebrane").whereEqualTo("MailKuriera", mail).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    @Override
        ...
        lvLista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(getApplicationContext(), KurierNieodebraneInfo.class);
